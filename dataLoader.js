...
const FORMULA_ONE_2026_ROUND_FORMS_SHEET_BASE_URL =
...
export const DATA_SOURCES = {
  sheets: {
    ...
    formulaOne2026RoundForms: buildFormulaOne2026RoundFormsCsvUrl("2022697649"),
...
function buildFormulaOne2026RoundFormsCsvUrl(gid) {
  return `${FORMULA_ONE_2026_ROUND_FORMS_SHEET_BASE_URL}?gid=${encodeURIComponent(gid)}&single=true&output=csv`;
}
