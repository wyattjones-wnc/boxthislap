...
The large Next widget shows up to four upcoming incomplete items as cards with artwork and dates. The medium widget shows one focused countdown. When Next is run in Scriptable, it asks which upcoming incomplete item the medium widget should focus on. That selection is saved on the phone.
