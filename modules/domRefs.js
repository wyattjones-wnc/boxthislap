...
export const rankingManualToEloButton = document.querySelector("#ranking-manual-to-elo-button");
export const rankingManualToEloStatus = document.querySelector("#ranking-manual-to-elo-status");
