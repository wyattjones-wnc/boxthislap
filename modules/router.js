...
const HOME_PAGES = ["footy", "footy-team", "next", "rankings", "guides", "footy-goal-assists", "leagues", "login", "manager-hub", "manager-awards"];
const THE_MONSTER_MANIAC_PAGES = ["the-monster-maniac", "todo", "want", "youtube"];
